...
- Сохранение изображений в Yandex Cloud Object Storage с возвратом S3-ссылки
...
API_PORT=8000
PARSE_TIMEOUT=30000
YC_ACCESS_KEY_ID=your_yc_access_key
YC_SECRET_ACCESS_KEY=your_yc_secret_key
YC_BUCKET=your-public-bucket
YC_REGION=ru-central1
YC_ENDPOINT=https://storage.yandexcloud.net
YC_PUBLIC_BASE_URL=https://storage.yandexcloud.net/your-public-bucket
```
...
```json
{
  ...
  "metadata": {
    ...
    "image": "https://storage.yandexcloud.net/your-public-bucket/telegram-previews/2026-04-24/uuid.jpg",
